...
"""
This component reads PolyCurves exported from Dynamo
    ...
    Args:
        ...
        _import: boolean True or False that will either allow or prevent geometry \
            from being imported
"""
ghenv.Component.Name = "Mantis Shrimp - PolyCurve"
ghenv.Component.NickName = 'DSPolyCurve'
...
if _import:
    ...
    outPolyCurve = list_to_tree(dataList)
