...
"""
This component reads Lines exported from Dynamo
    ...
    Args:
        ...
        _import: boolean True or False that will either allow or prevent geometry \
            from being imported
"""
ghenv.Component.Name = "Mantis Shrimp - Line"
ghenv.Component.NickName = 'DSLine'
...
def toRHObject(item):
    if type(item) == ms.MSLine:
        return item.toRHLineCurve(sc.doc.ModelUnitSystem.ToString())
