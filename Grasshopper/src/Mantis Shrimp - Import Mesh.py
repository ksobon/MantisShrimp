...
"""
This component reads Meshes exported from Dynamo
    ...
    Args:
        ...
        _import: boolean True or False that will either allow or prevent geometry \
            from being imported
"""
ghenv.Component.Name = "Mantis Shrimp - Mesh"
ghenv.Component.NickName = 'DSMesh'
...
def toRHObject(item):
    if type(item) == ms.MSMesh:
        return item.toRHMesh(sc.doc.ModelUnitSystem.ToString())
