...
"""
This component reads PolySurfaces exported from Dynamo
    ...
    Args:
        ...
        _import: boolean True or False that will either allow or prevent geometry \
            from being imported
"""
ghenv.Component.Name = "Mantis Shrimp - Brep"
ghenv.Component.NickName = 'DSBrep'
...
def toRHObject(item):
    if type(item) == ms.MSBrep:
        return item.toRHBrep()
