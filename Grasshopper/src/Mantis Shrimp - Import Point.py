...
"""
This component reads Points exported from Dynamo
    ...
    Args:
        ...
        _import: boolean True or False that will either allow or prevent geometry \
            from being imported
"""
ghenv.Component.Name = "Mantis Shrimp - Point"
ghenv.Component.NickName = 'DSPoint'
...
def toRHObject(item):
    if type(item) == ms.MSPoint:
        return item.toRHPoint3d(sc.doc.ModelUnitSystem.ToString())
...
if _import:
    ...
    outPoint = list_to_tree(dataList)
